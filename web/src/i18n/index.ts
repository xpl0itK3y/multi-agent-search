...
const ru = {
  ...
  watch: {
    ...
    every: "Частота",
    intervals: { hourly: "ежечасно", daily: "ежедневно", weekly: "еженедельно", custom: "своя" },
    stop: "Перестать следить",
    changed: "Ответ изменился",
    changedHint: "с момента, когда вы смотрели в последний раз — детали в «Что изменилось» ниже",
    markSeen: "Отметить просмотренным",
  },
  diff: {
...
const en: typeof ru = {
  ...
  watch: {
    ...
    every: "Frequency",
    intervals: { hourly: "hourly", daily: "daily", weekly: "weekly", custom: "custom" },
    stop: "Stop watching",
    changed: "The answer changed",
    changedHint: "since you last looked — see “What changed” below",
...
const es: typeof ru = {
  ...
  watch: {
    watch: "Vigilar",
    hint: "Reejecutar esta pregunta periódicamente y avisar cuando la respuesta cambie",
    every: "Frecuencia",
    intervals: { hourly: "cada hora", daily: "cada día", weekly: "cada semana", custom: "personalizado" },
    stop: "Dejar de vigilar",
    changed: "La respuesta cambió",
    changedHint: "desde la última vez que la viste — mira «Qué cambió» abajo",
